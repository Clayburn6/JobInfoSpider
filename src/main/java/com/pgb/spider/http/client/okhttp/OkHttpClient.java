...
import com.pgb.spider.http.HttpParams;
import com.pgb.spider.http.client.AbstractHttpClient;
...
public class OkHttpClient extends AbstractHttpClient {
    ...
    private Logger logger = Logger.getLogger(OkHttpClient.class);
    private okhttp3.OkHttpClient.Builder clientBuilder;

    public OkHttpClient() {
        this.clientBuilder = new okhttp3.OkHttpClient.Builder().cookieJar(new CookieManager());
        this.httpHeader.put("spider", "hello-spider");
    }
